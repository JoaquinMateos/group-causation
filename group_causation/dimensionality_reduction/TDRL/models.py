...
from .hmm import HMM
from .metrics_correlation import compute_mcc, compute_acc
from group_causation.dimensionality_reduction.TDRL.mixin import PLDimensionalityReductionMixin


class TDRL(pl.LightningModule, PLDimensionalityReductionMixin):
    def __init__(
            self,
            x_dim,
            z_dim,
...
class CTDRL(pl.LightningModule, PLDimensionalityReductionMixin):
    def __init__(
            self,
            x_dim,
            z_dim,
